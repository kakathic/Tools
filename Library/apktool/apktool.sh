# kakathic
Xu_install zip
Taive "https://github.com/iBotPeaches/Apktool/releases/download/v${2//_/}/$1$pb.jar" "/data/tools/Tools/$1.jar"
...
cd $TMPDIR
zip -qr -9 "/data/tools/Tools/$1.jar" prebuilt/* -d prebuilt/windows/* prebuilt/macosx/*
